...
const SUGGESTED: { key: string; hint: string }[] = [
  ...
  { key: "low_stock_threshold", hint: "Со скольки штук показывать «Осталось всего N шт.» на карточке товара и в посте акции. По умолчанию 10. Показывается только настоящий остаток; когда товара больше порога — строки нет. 0 = выключить. У Stars и Premium склада нет, там строка не показывается никогда." },
