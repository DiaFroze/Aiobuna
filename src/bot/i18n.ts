...
const RU: Dict = {
  ...
  topup_retired: "ℹ️ Пополнение баланса больше не нужно — товар оплачивается сразу при покупке. Откройте магазин и выберите товар.",
  promo_retired: "ℹ️ Промокоды временно не работают: они начисляли баланс, а баланс отключён. Напишите администратору — он сделает скидку на товар.",
  low_stock: "🔥 Осталось всего <b>{n} шт.</b>",
  ...
  course_payment_required: "Оплатите курс одним из доступных способов на странице заказа.",
  payme_created: "💳 <b>Счёт на {v} создан.</b>\n\nНажмите кнопку ниже и оплатите через Payme. После оплаты баланс пополнится автоматически — вернитесь в бот через пару секунд.",
  ...
  uname_ask:
    "👤 <b>Кому доставить?</b>\n\n{item}\n\nОтправьте @username аккаунта Telegram, на который придёт покупка.\n\n<i>Например: @durov</i>",
  uname_bad_empty: "Отправьте @username текстом.",
  uname_bad_chars: "❌ В username бывают только латинские буквы, цифры и « _ ».\n\nПроверьте раскладку — русские буквы выглядят похоже, но не подходят.",
  uname_bad_short: "❌ Слишком короткий — минимум 5 символов.",
  uname_bad_long: "❌ Слишком длинный — максимум 32 символа.",
  uname_bad_start: "❌ Username начинается с латинской буквы.",
  uname_bad_end: "❌ Username не может заканчиваться на « _ ».",
  uname_bad_double: "❌ Два подчёркивания подряд не бывают.",
  uname_confirm:
    "⚠️ <b>Проверьте внимательно</b>\n\n{item}\nПолучатель: <b>@{u}</b>\n\nПосле оплаты доставка идёт на этот аккаунт и <b>отменить её нельзя</b>.\n\nВсё верно?",
  uname_confirm_yes: "✅ Да, всё верно",
  uname_confirm_edit: "✏️ Изменить username",
  uname_for: "Получатель",
  ...
  card_pay_instructions:
    'Оплата картой <tg-emoji emoji-id="5472296756152644790">💳</tg-emoji> / <tg-emoji emoji-id="5346328681075712891">💳</tg-emoji>\n\n' +
    "Товар: <b>{item}</b>\n" +
    "Количество: <b>{qty}</b>\n\n" +
  ...
  card_chk_pending: "Платёж пока не найден. Заявка активна, повторно переводить деньги не нужно.",
...
const EN: Dict = {
  ...
  topup_retired: "ℹ️ Topping up a balance is no longer needed — you pay for an item when you buy it. Open the shop and pick a product.",
  promo_retired: "ℹ️ Promo codes are paused: they credited a balance, and the balance is switched off. Message the administrator for a discount instead.",
  low_stock: "🔥 Only <b>{n} left</b>",
  ...
  pay_payme: "💳 Pay with Payme",
  course_payment_required: "Pay for the course using one of the available methods on the order screen.",
  payme_created: "💳 <b>Invoice for {v} created.</b>\n\nTap the button below and pay via Payme. Your balance tops up automatically once paid — come back in a couple of seconds.",
  ...
  uname_ask:
    "👤 <b>Who is it for?</b>\n\n{item}\n\nSend the @username of the Telegram account that should receive it.\n\n<i>For example: @durov</i>",
  uname_bad_empty: "Please send the @username as text.",
  uname_bad_chars: "❌ A username contains only latin letters, digits and “_”.\n\nCheck your keyboard layout — cyrillic letters look alike but won't work.",
  uname_bad_short: "❌ Too short — 5 characters minimum.",
  uname_bad_long: "❌ Too long — 32 characters maximum.",
  uname_bad_start: "❌ A username starts with a latin letter.",
  uname_bad_end: "❌ A username can't end with “_”.",
  uname_bad_double: "❌ Two underscores in a row aren't allowed.",
  uname_confirm:
    "⚠️ <b>Please check carefully</b>\n\n{item}\nRecipient: <b>@{u}</b>\n\nAfter payment the delivery goes to this account and <b>cannot be reversed</b>.\n\nIs this correct?",
  uname_confirm_yes: "✅ Yes, that's right",
  uname_confirm_edit: "✏️ Change username",
  uname_for: "Recipient",
  btn_got_it: "✅ I got it",
  ...
  card_pay_instructions:
    'Pay by card <tg-emoji emoji-id="5472296756152644790">💳</tg-emoji> / <tg-emoji emoji-id="5346328681075712891">💳</tg-emoji>\n\n' +
    "Product: <b>{item}</b>\n" +
  ...
  card_chk_pending: "Payment not found yet. Request is active, no need to send money again.",
...
const UZ: Dict = {
  ...
  topup_retired: "ℹ️ Balansni to‘ldirish endi kerak emas — mahsulot xarid paytida to‘lanadi. Do‘konni oching va mahsulot tanlang.",
  promo_retired: "ℹ️ Promokodlar vaqtincha ishlamaydi: ular balansga pul qo‘shardi, balans esa o‘chirilgan. Chegirma uchun administratorga yozing.",
  low_stock: "🔥 Atigi <b>{n} ta qoldi</b>",
  ...
  course_payment_required: "Kurs uchun buyurtma sahifasidagi mavjud usullardan biri orqali to‘lang.",
  payme_created: "💳 <b>{v} uchun hisob yaratildi.</b>\n\nQuyidagi tugmani bosing va Payme orqali to'lang. To'lovdan so'ng balans avtomatik to'ldiriladi — bir necha soniyadan keyin botga qayting.",
  ...
  uname_ask:
    "👤 <b>Kimga yetkazamiz?</b>\n\n{item}\n\nXaridni oladigan Telegram akkauntining @username'ini yuboring.\n\n<i>Masalan: @durov</i>",
  uname_bad_empty: "@username'ni matn ko'rinishida yuboring.",
  uname_bad_chars: "❌ Username'da faqat lotin harflari, raqamlar va « _ » bo'ladi.\n\nKlaviatura tilini tekshiring — kirill harflari o'xshash, lekin to'g'ri kelmaydi.",
  uname_bad_short: "❌ Juda qisqa — kamida 5 ta belgi.",
  uname_bad_long: "❌ Juda uzun — ko'pi bilan 32 ta belgi.",
  uname_bad_start: "❌ Username lotin harfi bilan boshlanadi.",
  uname_bad_end: "❌ Username « _ » bilan tugamaydi.",
  uname_bad_double: "❌ Ketma-ket ikkita pastki chiziq bo'lmaydi.",
  uname_confirm:
    "⚠️ <b>Diqqat bilan tekshiring</b>\n\n{item}\nQabul qiluvchi: <b>@{u}</b>\n\nTo'lovdan keyin xarid shu akkauntga boradi va <b>bekor qilib bo'lmaydi</b>.\n\nHammasi to'g'rimi?",
  uname_confirm_yes: "✅ Ha, to'g'ri",
  uname_confirm_edit: "✏️ Username'ni o'zgartirish",
  uname_for: "Qabul qiluvchi",
  btn_got_it: "✅ Oldim",
  ...
  card_pay_instructions:
    'Karta orqali to‘lash <tg-emoji emoji-id="5472296756152644790">💳</tg-emoji> / <tg-emoji emoji-id="5346328681075712891">💳</tg-emoji>\n\n' +
    "Mahsulot: <b>{item}</b>\n" +
    "Miqdor: <b>{qty} dona</b>\n\n" +
  ...
  card_chk_pending: "To‘lov hozircha topilmadi. Ariza faol, pulni qayta o‘tkazish shart emas.",
